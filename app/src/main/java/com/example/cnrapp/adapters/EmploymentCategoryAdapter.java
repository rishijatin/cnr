...
public class EmploymentCategoryAdapter extends RecyclerView.Adapter<EmploymentCategoryAdapter.MyViewHolder> {

    List<EmploymentCategory> categories;
    RecyclerViewItemClickListener mListener;

    public EmploymentCategoryAdapter(List<EmploymentCategory> categories) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        EmploymentCategory category = categories.get(position);
